...
# Realistic partially coherent thermal state for environment ancilla at room temperature
def realistic_env_state(omega=1.0, temperature=0.01, coherence_strength=0.1):
    k_B = 1.0
...
for p_swap in p_values:
    ...
    plt.plot(collisions, ergo_val, label=f"p={p_swap},ergo", linewidth=2)

plt.xlabel("Number of Collisions", fontsize=14)
plt.ylabel("Ergotropy", fontsize=14)
plt.title("Ergotropy vs. Number of Collisions at Room Temperature", fontsize=16)
